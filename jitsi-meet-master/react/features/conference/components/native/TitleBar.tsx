...
import stylesstylesForOverflowMenuButton from '../../../toolbox/components/native/styles'
...
const TitleBar = (props: IProps) => {
    const { _visible, _iAmVisitor } = props;
    const { buttonStylesBorderless, hangupButtonStyles, toggledButtonStyles } = stylesstylesForOverflowMenuButton;
