 ...
 * 通話銀幕縮小切換
 * {
 *     type: TOGGLE_ZOOM_OUT_MODE
 * }
 */
export const TOGGLE_ZOOM_OUT_MODE = 'TOGGLE_ZOOM_OUT_MODE';

/**
 * charles新增
 * 通話銀幕放大切換
 * {
 *     type: TOGGLE_ZOOM_IN_MODE
 * }
 */
export const TOGGLE_ZOOM_IN_MODE = 'TOGGLE_ZOOM_IN_MODE';
