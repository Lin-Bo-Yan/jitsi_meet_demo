 ...
 */
class ChangeVoiceCallDeviceButton extends AbstractButton<AbstractButtonProps> {
...
export default translate(connect(_mapStateToProps)(ChangeVoiceCallDeviceButton));
